...
- Name: src/tests/features/registration.feature.spec.js >> Registration form >> Registration summary displays correct user details
- Location: .features-gen/src/tests/features/registration.feature.spec.js:16:7
...
Locator: locator('#resultLn')
Expected substring: "Last Name: Knight"
Received string:    "Last Name: Knigh"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#resultLn')
    9 × locator resolved to <div id="resultLn">Last Name: Knigh</div>
      - unexpected value "Last Name: Knigh"
  ...
  - generic [ref=e53]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e83]:
        ...
        - textbox "Enter email" [ref=e85]: john@example.com
      - generic [ref=e86]:
    ...
    - generic [ref=e95]:
      ...
      - generic [ref=e97]: "First Name: John"
      - generic [ref=e98]: "Last Name: Knigh"
      - generic [ref=e99]: "Phone Number: 021024965210"
      - generic [ref=e100]: "Country: New Zealand"
      - generic [ref=e101]: "Email: john@example.com"
```

...
- Name: src/tests/features/registration.feature.spec.js >> Registration form >> User can register after agreeing to the policy
- Location: .features-gen/src/tests/features/registration.feature.spec.js:10:7

# Error details

```
TypeError: Cannot read properties of undefined (reading 'rowsHash')
```
  ...
  - generic [ref=e53]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e76]:
        ...
        - textbox "Enter phone number" [ref=e78]: "5551234567"
    ...
    - generic [ref=e95]:
      ...
      - generic [ref=e99]: "Phone Number: 5551234568"

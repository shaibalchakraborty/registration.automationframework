...
- Name: src/tests/features/registration.feature.spec.js >> Registration form >> Registration should not succeeds when the email is missing
- Location: .features-gen/src/tests/features/registration.feature.spec.js:44:7

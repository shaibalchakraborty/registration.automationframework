...
- Name: src/tests/features/registration.feature.spec.js >> Registration form >> Registration should not succeeds with invalid email format
- Location: .features-gen/src/tests/features/registration.feature.spec.js:49:7
  ...
  - generic [ref=e53]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e83]:
        ...
        - textbox "Enter email" [ref=e85]: not-proper-email
      - generic [ref=e86]:
